INSERT INTO `small_kdw`.`member` (`me_id`, `me_pw`, `me_name`, `me_authority`, `me_point`) 
	VALUES ('abc', 'abc', 'ABC마트', 'MEMBER', '0');
INSERT INTO `small_kdw`.`member` (`me_id`, `me_pw`, `me_name`, `me_birth`, `me_authority`, `me_point`) 
	VALUES ('qwe', 'qwe', '홍길동', '2000-01-01', 'MEMBER', '0');
INSERT INTO `small_kdw`.`member` (`me_id`, `me_pw`, `me_name`, `me_authority`) 
	VALUES ('admin', 'admin', '관리자', 'ADMIN');
INSERT INTO `small_kdw`.`member` (`me_id`, `me_pw`, `me_name`, `me_birth`, `me_authority`, `me_point`) 
	VALUES ('hi', 'hi', '고길동', '2002-01-01', 'MEMBER', '0');
